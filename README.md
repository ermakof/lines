...
Основой «S-LINES» является игровое поле (стол), состоящее из ячеек, предназначенных для размещения шариков. Форм-фактор поля - квадрат. Размер стола можно регулировать перед началом. Самый маленький: 4 на 4 ячейки. Максимум: 9 на 9.
